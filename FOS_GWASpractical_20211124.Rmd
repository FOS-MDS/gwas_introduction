...
This file you will use to follow the practical, while you use the RMD file to run code that is required to answer the questions.
FOS_GWASpractical_20211124.RMD
Please, add your name and date on the top of this file where it says "Insert your name here"and "Insert the date here" and save a personalized version of the RMD file with your answers. Please insert the answers wherever you see the **A.** in this file.
At the end of the practical, please push the publish button that you can see on the top and save the file as an .html. Finally, you will need to upload your personal .html file including all answers to Turnitin on Brightspace.
