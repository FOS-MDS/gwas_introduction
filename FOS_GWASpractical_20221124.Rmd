---
title: "FOS 2022 GENOME-WIDE ASSOCIATION ANALYSIS PRACTICAL"
...
FOS_GWASpractical_20221124.html
FOS_GWASpractical_20221124.RMD
...
Open the .html file on your browser by clicking over "FOS_GWASpractical_20221124.html" in the Files window of RStudio (bottom right) and pressing "View in Web Browser".

Please, add your name and date on top of this file where it says "Insert your name here"and "Insert the date here" and reply to the questions with your answers wherever you see the **A.**.
...
**Q12.** Are there any samples that represent ethnic outliers on mdsplot? How would you deal with those samples in the GWAS?\
...
**Q19.** To create QQ plot, you will use an online tool, locus zoom (http://locuszoom.org/). This tool accepts a file with following information for each variant: chromosome, position, reference and alt alleles, and p-value (or -log10 p). The results have already been uploaded to the website. Go to https://my.locuszoom.org/gwas/571690/?token=55852dc8d8514c6481e76807dbf41d6f and check the QQ plot. Does it look acceptable?\
...
**Q22.** To create Manhattan plot, you will again use the online tool, locus zoom (http://locuszoom.org/). The results have already been uploaded to the website. Go to https://my.locuszoom.org/gwas/571690/?token=55852dc8d8514c6481e76807dbf41d6f and explore the Manhattan plot. What is the p-value threshold of the grey dotted line?\
...
**Q35** What is beta for your top SNPs and how you could interpret it?\
...
**Q36.** Do the results make any sense given that the trait is circulating level of betaine? (hint: What is the function of the top genes?)\
**A36.** Please type your answer here.

**Q37.** Which pathways are these genes involved in?\
**A37.** Please type your answer here.

**Q38.** Did any other GWAS find the similar answer as you did?\
...
**Q39.** Would you use similar of different population for replication and why?\
**A39.** Please type your answer here.

**Q40.** Which SNPs would you select for replication and why?\
**A40.** Please type your answer here.

**Q41.** Would you involve meta-analysis of the original summary? statistic results and the results from validation study and why?\
**A41.** Please type your answer here.
